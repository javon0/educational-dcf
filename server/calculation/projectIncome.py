...
oe_percent = income['operatingExpenses'] / income['revenue']
...
py1_data = {'date': str(py1_date),'revenue':py1_revenue, 'costOfRevenue': py1_cogs, 'grossProfit': py1_gross,'operatingExpenses': py1_oe, 'operatingIncome': py1_ebit, 'growth_rate': rates[0]}
